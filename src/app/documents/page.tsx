          ...
          <div className="space-y-4">
              ...
              <div className="flex-1">
                <div className="relative">
                  <input
                    ...
                    placeholder="Поиск документов (например: соглашение, конфиденциальность)"
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Найдено документов: <span className="font-semibold text-gray-900">{filteredDocuments.length}</span>
                {hasActiveFilters && (
                  <span className="ml-2">из <span className="font-semibold">{documents.length}</span></span>
                )}
              </div>
              {hasActiveFilters && (
                <button
