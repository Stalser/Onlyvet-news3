...
export default function ServicesPricesPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Компактные фильтры */}
      <section className="py-3 bg-white border-b border-gray-200 sticky top-0 z-50 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative w-40">
              <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Поиск..." className="w-full px-3 py-1.5 pl-9 rounded-md border border-gray-300 focus:ring-2 focus:ring-primary text-sm outline-none" />
          ...
          <p className="text-xs text-gray-500 mt-2">Найдено: <span className="font-bold text-gray-900">{filteredServices.length}</span></p>
        </div>
      </section>
